...
#         with st.spinner('AI is screeing...'):
...
#                 new_name = st.text_input("Enter your name",placeholder="E.g.Madhura vani")
...
#                 try:
#                     audio_data = st.audio_input('Record a short phrase like I am present, My name is Madhura.')
