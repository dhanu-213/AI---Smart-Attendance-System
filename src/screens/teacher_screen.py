...
def teacher_dashboard():
    ...
    with tab1:
        ...
        if st.button('Take Attendance',type=type1,width='stretch',icon=':material/how_to_reg:',key='take_attendance_btn'):
            st.session_state.current_teacher_tab='take_attendance'
            st.rerun()
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username",placeholder='madhuravani')
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name",placeholder='Madhura Vani')
